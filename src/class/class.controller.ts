...
export class ClassController {
  ...
  @ApiOperation({
    summary:
      'Retrieve a list of classes requirement using set of filter attributes.',
  })
  @Get('classes')
  ...
  @ApiOperation({
    summary: 'Student/Tutor retrieves a list of classes of his own.',
  })
  @Get('my/classes')
  ...
  @ApiOperation({
    summary: 'Admin/Manager retrieves a list of classes by student id.',
  })
  ...
  @ApiOperation({
    summary: 'Admin/Manager retrieves a list of classes by tutor id.',
  })
  ...
  @ApiOperation({
    summary: 'Admin/Manager retrieves a list of classes by user id.',
  })
